            ...
            <div class="card-body">
                <form action="{{route('menu.prosesTambah')}}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_menu" placeholder="Nama Menu" value="{{old('nama_menu')}}"
                    ...
                    <div class="mb-3">
                        ...
                        <div id="url_tampil">
                            <input type="url" name="link_url" class="form-control value="
                                   {{old('link_url')}} placeholder="URL">
                        </div>
