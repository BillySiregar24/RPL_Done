...
Route::group(['middleware' => ['auth.user', 'auth:user']], function () {
    Route::prefix('admin')->group(function (){
        ...
        Route::get('/resetPassword', [DashboardControllerAlias::class, 'resetPassword'])->name('dashboard.resetPassword');
        Route::post('/resetPassword', [DashboardControllerAlias::class, 'prosesResetPassword'])->name('dashboard.prosesResetPassword');
        ...
        Route::get('/kategori/expot-pdf',[App\Http\Controllers\KategoriController::class, 'exportPdf'])->name('kategori.exportPdf');
        ...
        Route::get('/page/expot-pdf',[App\Http\Controllers\PageController::class, 'exportPdf'])->name('page.exportPdf');
